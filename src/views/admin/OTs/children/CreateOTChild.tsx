...
import FormSelectClient from "../creacion/forms/SelectClient";

export const CreateOtChild = () => {
    ...
    const createRequest = mutatorRequest('/admin/children/ots/create-ot', 'POST', {
        ...data,
        otId: id
    })

...
import { GetInsumoAdmin } from "../../../helpers/admin/insumos"
...
export const UpdateInsumo = () => {
    ...
    const insumo = useQuery(['GetInsumos', id], () => GetInsumoAdmin(id));

    useEffect(() => {
        if (insumo.data?.data) {
            setData({
                ...data,
                title: insumo.data.data.title,
                description: insumo.data.data.description,
                marca: insumo.data.data.marca,
                modelo: insumo.data.data.modelo,
                stock: insumo.data.data.stock,
                nro_componente: insumo.data.data.nro_componente,
                year: insumo.data.data.year,
            })
        }
    }, [insumo.data]);
    ...
    const updateMutator = mutatorRequest('/admin/insumos/update/'+id, 'PUT', data);
    ...
    return (
        <Fragment>
            ...
            <ModalSuccessGenerico openDialogSuccess={openDialogSuccess} setOpenDialogSuccess={setOpenDialogSuccess}
                title='Insumo Actualizado' subtitle="El insumo se ha actualizado correctamente" returnTo="/admin/insumos"
            />
                        ...
                        <Grid item xs={12} justifyContent='center' textAlign={'center'}>
                            {/* <FormGroup> */}
                                <Button variant='contained' sx={{
                                    ...
                                    disabled={updateMutator.isLoading}
                                >
                                    Actualizar
                                </Button>
                            {/* </FormGroup> */}
